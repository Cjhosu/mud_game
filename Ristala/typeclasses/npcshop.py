...
from evennia import Command, DefaultExit, DefaultObject
...
class CmdBuildShop(Command):
    ...
    def func(self):
        ...
        storeroom_key = create_object(DefaultObject,
                                      ...
                                      location=storeroom)
        # allow only chars with this key to enter or exit the store room
        shop_exit.locks.add("traverse:holds(%s)" % storeroom_key.key)
        storeroom_exit.locks.add("traverse:holds(%s)" % storeroom_key.key)
